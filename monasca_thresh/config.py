...
from monasca_thresh import conf
from monasca_thresh import version
...
def parse_args(description='Computes thresholds on metrics and publishes alarms to Kafka and MySQL when exceeded'):
    global _CONF_LOADED
    if _CONF_LOADED:
